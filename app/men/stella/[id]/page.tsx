...
import { ArrowIcon, NextIcon } from "@/components/Icons";
...
export default function ItemPage() {
  ...
  const params = {
    ...
    id: query.get("id"),
    secondImgLink: query.get("secondImgLink"),
  };
  ...
  return (
    <>
      <article className="w-[90%] box-border md:w-[68%] mx-auto mb-4 overflow-y-scroll flex max-w-[470px] md:max-w-[740px] md:min-w-[740px]">
        <div className="md:flex">
          <div className="md:w-[70%] overflow-hidden relative">
            <ImageMagnifier
              imgLink={!secondImage ? params.imgLink : params.secondImgLink}
            ></ImageMagnifier>
      ...
      <div className="w-[90%] mx-auto flex mb-10">
        {ranArray.map((col: DressItem, key: number) => {
          const count = 3;
          if (key + 1 === 3) {
            return;
          }
